...
export function ContextStarter() {
  const { isStarted, markAsStarted } = useToneContext();
  ...
  return (
    <>
      {!isStarted && (
        <>
          <div className='fixed top-0 left-0 z-10 w-full h-full bg-black/80'></div>
          <div className='fixed z-20 rounded-full p-4 -translate-x-[50%] -translate-y-[50%] bg-neutral-800 shadow-lg left-1/2 top-1/2'>
            <button
